...
const contact = [
    { icon: Mail, label: 'Contact via Email', value: 'sameerbagul2004@gmail.com', href: 'mailto:sameerbagul2004@gmail.com' },
    { icon: Linkedin, label: 'LinkedIn Profile', value: '@sameer-bagul', href: 'https://linkedin.com/in/sameer-bagul' },
    { icon: Github, label: 'GitHub Repository', value: '@Sameer-Bagul', href: 'https://github.com/Sameer-Bagul' },
];
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        ...
                        <GlassCard className="p-8">
                            ...
                            <div className="space-y-6">
                                {achievements.map((ach, i) => (
                                    <div key={ach._id} className="flex gap-4 group">
                                        <div className="w-10 h-10 rounded-xl bg-zinc-100 dark:bg-zinc-900 flex items-center justify-center shrink-0 group-hover:bg-primary group-hover:text-primary-foreground transition-all">
                                            <Trophy size={18} />
                                        </div>
                                        <div>
                                            <p className="text-sm font-black uppercase tracking-tight leading-none mb-1">{ach.title}</p>
                                            <p className="text-[10px] text-muted-foreground font-medium">{ach.description || ach.date}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                        ...
                        <div className="space-y-4">
                            {contact.map((cta, i) => (
                                ...
                                >
                                    <GlassCard className="p-4 flex items-center justify-between group-hover:border-primary/40 transition-all">
                                        <div className="flex items-center gap-4">
                                            <div className="w-10 h-10 rounded-xl bg-primary/5 flex items-center justify-center text-primary">
                                                <cta.icon size={18} />
                                            </div>
                                            <div>
                                                <p className="text-[8px] font-black uppercase tracking-widest text-muted-foreground">{cta.label}</p>
                                                <p className="text-xs font-bold">{cta.value}</p>
                                            </div>
                                        </div>
